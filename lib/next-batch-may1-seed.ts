// May 1 2026 next-batch — 30 net-new companies, small/early-stage with strong VC backing.
// Filters applied: avoiding healthcare, bio, AND defense.
// Names include lead VC in parens.

import type { EntryType, Domain } from "./types";

export interface NextBatchSeed {
  /** Final name including lead VC in parens, e.g., "Lovable (Accel)" */
  finalName: string;
...
export const NEXT_BATCH_2026_05_01: NextBatchSeed[] = [
  ...
  { finalName: "Retell AI (Y Combinator)", type: "company", domain: "frontier-ai", note: "Voice AI infra. Tiny (~10). YC W24." },
  { finalName: "Continue (Heavybit)", type: "company", domain: "infra-devtools", note: "OSS coding assistant. ~15 ppl. ex-GitHub." },
  { finalName: "Stagehand (Browserbase)", type: "company", domain: "infra-devtools", note: "OSS browser automation framework. Tiny eng team." },
